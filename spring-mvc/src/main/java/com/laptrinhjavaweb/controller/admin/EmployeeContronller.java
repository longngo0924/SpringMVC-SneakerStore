...
import com.laptrinhjavaweb.service.UserSer;
...
public class EmployeeContronller {
	...
	public String luuEmp(@ModelAttribute("sanPham") EmployeeDTO sanPham,HttpSession session,BindingResult bindingResult) throws IOException{
	...
	public String suaTrangThaiNguoiDung(@PathVariable String userName, @PathVariable long id,@PathVariable int status ) {
