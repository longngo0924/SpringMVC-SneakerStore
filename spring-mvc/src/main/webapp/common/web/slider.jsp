			...
			<div class="seq-screen">
				<ul class="seq-canvas">
					...
					<li>
						<div class="seq-model">
							<img data-seq
								src="<c:url value='/template/web/assets/images/slide_1.jpg'/>"
								alt="Men slide img" />
						</div>
						<div class="seq-title">
					...
					<li>
						<div class="seq-model">
							<img data-seq
								src="<c:url value='/template/web/assets/images/slide_2.jpg'/>"
					...
					<li>
						<div class="seq-model">
							<img data-seq
								src="<c:url value='/template/web/assets/images/slide_3.jpg'/>"
					...
					<li>
						<div class="seq-model">
							<img data-seq
								src="<c:url value='/template/web/assets/images/slide_4.jpg'/>"
								alt="Shoes slide img" />
						</div>
						<div class="seq-title">
