							...
							<div class="col-md-4 col-sm-6">
								<div class="aa-footer-widget">
									<a href="${pageContext.request.contextPath}/"><img
										src="<c:url value='/template/web/assets/images/logo1.png'/>" alt="logo img"
										width="30%"></a>
									<ul class="aa-footer-nav">

										<li><p
												style="color: #888; text-align: justify; width: 95%">Là
												nơi chuyên buôn bán tất cả các mặt hàng về giày dép chất
												lượng. Chúng tôi luôn đặt tiêu chí về chất lượng và uy tín
												lên hàng đầu.</p></li>
										<li><img
											src="<c:url value='/template/web/assets/images/dadangky.png'/>"
							...
							<div class="col-md-4 col-sm-6">
								<div class="aa-footer-widget">
									<div class="aa-footer-widget">
										<h3>LIÊN HỆ</h3>
										<address>
											<p>12 Nguyễn Văn Bảo - Phường 4 - Q.Gò Vấp - TP.HCM</p>
											<p>
												<span class="fa fa-phone"></span>037.7026.186
											</p>
											<p>
												<span class="fa fa-envelope"></span>23labsneakerstore@gmail.com
											</p>
										</address>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="aa-footer-bottom-area">
						<p>Copyright 2021 &copy 23LAB Team</p>
