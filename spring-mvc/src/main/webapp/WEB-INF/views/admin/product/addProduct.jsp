										...
										<form method="post"
											...
											<div class="form-group">
												...
												<div class="form-group row">
													<label cssClass="col-sm-2 col-form-label">Category</label>
													<div class="col-sm-12">
												...
												<div class="form-group row">
													<label cssClass="col-sm-2 col-form-label">Company</label>
													<div class="col-sm-12">
												...
												<div class="form-group">
													<label for="input-1">Ảnh đại diện</label> <input
														type="file" class="form-control" placeholder="Tên hình"
														name="anh">
												</div>
