							...
							<div class="col-lg-12">
								<div class="card">
									<div class="card-body">
										...
										<hr>
										<form method="post"
											action="${pageContext.request.contextPath}/manage/customer/add">
											...
											<div class="form-group">
												<label for="input-3">Addess</label> <input type="text"
													...
													placeholder="Nhập địa chỉ" name="user-address">
											</div>
											<div class="form-group">
												<label for="input-3">Gender</label>
												<div>
													<select class="form-control valid" id="input-6"
														name="user-gender" required aria-invalid="false">
											...
											<div class="form-group">
												<label for="input-3">UserName</label> <input type="text"
													...
													placeholder="Nhập User Name" name="user-userName">
											</div>
											<div class="form-group">
												<label for="input-4">Mật khẩu</label> <input type="password"
													class="form-control" id="myinput"
													placeholder="Nhập mật khẩu" name="user-password"> <input
											...
											<div class="form-footer">
												<button class="btn btn-danger">
													<i class="fa fa-times"></i><a
														href="${pageContext.request.contextPath}/manage/customer/listCus">Hủy</a>
												</button>
