									...
									<div class="card-body">
										...
										<form action="luu-thong-tin" method="POST">
											...
											<div class="form-group">
												<label for="input-1">Employee Name</label> <input
													type="text" class="form-control" id="input-1"
													placeholder="Tên sản phẩm" name="name" value="${sp.name }"
													required>
											</div>
											<div class="form-group">
												<label for="input-1">Employee Email</label> <input
													type="text" class="form-control" id="input-1"
													placeholder="Tên sản phẩm" name="email" value="${sp.email}"
													required>
											</div>
											<div class="form-group">
												<label for="input-1">Employee Phone</label> <input
													type="text" class="form-control" id="input-1"
													placeholder="Tên sản phẩm" name="phone"
													value="${sp.phone }" required>
											</div>
											<div class="form-group">
												<label for="input-1">Employee Address</label> <input
													type="text" class="form-control" id="input-1"
													placeholder="Tên sản phẩm" name="address"
													value="${sp.address }" required>
											</div>
											<div class="form-group">
												<label for="input-1">Employee Salary</label> <input
													type="text" class="form-control" id="input-1" name="salary"
													value="${sp.salary }" required>
											</div>
