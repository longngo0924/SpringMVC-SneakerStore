                ...
                <div class="checkout-left">
                  <div class="panel-group" >
                   <c:if test="${sessionScope.username == null}">
                   		<p> Bạn cần đăng nhập để thanh toán! Đăng nhập <a href="${pageContext.request.contextPath}/dang-nhap" style="color: #754110">tại đây!</a></p>
                   </c:if>
				 <c:if test="${sessionScope.username != null}">
                    <!-- Shipping Address -->
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
                    ...
                    <img src="${pageContext.request.contextPath}/template/web/assets/img/paypal.jpg" border="0" alt="PayPal Acceptance Mark">    
