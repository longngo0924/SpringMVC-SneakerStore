              ...
              <div class="row">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <c:choose>
						<c:when test="10000">
	                      <span class="aa-product-price">nêu co discount</span><span class="aa-product-price"></span>
	                    </c:when>
	                    <c:otherwise>
	                      <c:forEach items="${productlist1}" var="product1">
		                      ...
		                      <span class="aa-product-price"><strong>1000 VNĐ</strong></span>
		                      <span class="aa-product-price"><del>10000 VNĐ</del></span>
	                      </c:if>
	                      </c:forEach>
	                    </c:otherwise>
	                     </c:choose>
